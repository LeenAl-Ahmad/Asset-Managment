...
typedef struct
{
    ...
    char ColourMapType;    // Type of colour map @none, 1=has palette
    char DataTypeCode;     // Type of image @none, 1=indexed, 2=rgb, 3=grey, +8=rle packed
...
public:
    ...
    bool SaveTGAToFile(const std::string& fileName, const byte* imageData, short width, short height, char bitsPerPixel);
